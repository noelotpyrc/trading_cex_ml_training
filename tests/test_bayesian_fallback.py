...
def main() -> None:
    ...
    if not data_path.exists():
        ...
        sys.argv = ["gen", "--output", str(data_path), "--rows", "150"]
        gen()
    ...
    from model.run_lgbm_pipeline import _tune_bayesian
    best = _tune_bayesian(config, prepared_dir, search_space)
    print("best_params (bayesian fallback):", best)
