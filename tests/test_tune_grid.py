...
def main() -> None:
    ...
    # Build minimal config for tuning function
    config = {
    ...
    from model.run_lgbm_pipeline import _tune_grid_search
    best = _tune_grid_search(config, prepared_dir, search_space)
